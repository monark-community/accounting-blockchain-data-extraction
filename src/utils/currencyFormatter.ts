...
export const formatCurrency = (amount: number, currency: string = 'USD', locale: string = 'en-CA'): string => {
...
export const getCryptoColor = (ticker: string): string => {
  return cryptoColors[ticker.toUpperCase()] || 'bg-gray-100 text-gray-800 border-gray-200';
};
