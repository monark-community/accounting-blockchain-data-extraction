...
import { Wallet, Download, FileText, BarChart3, TrendingUp, TrendingDown, Fuel } from "lucide-react";
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="text-center mb-6">
                ...
                <h2 className="text-3xl font-bold text-slate-800 mb-2">Analyze Your Wallet</h2>
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="wallet" className="text-slate-700 font-medium">
                    Wallet Address
                  </Label>
                  <Input
                    id="wallet"
