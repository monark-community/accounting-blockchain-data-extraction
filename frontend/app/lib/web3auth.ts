...
const chainConfig = {
  ...
  rpcTarget: `https://rpc.ankr.com/eth${process.env.NEXT_PUBLIC_ANKR_API_KEY ? `/${process.env.NEXT_PUBLIC_ANKR_API_KEY}` : ''}`,
...
const openloginAdapter = new OpenloginAdapter({
  adapterSettings: {
    network: 'testnet',
    clientId: process.env.NEXT_PUBLIC_WEB3AUTH_CLIENT_ID || "BFe98cszmbLtc3IRlPEe43JCcz0nGfA-_lIIwxFamwleAtF_WyJRevv26XJ4qs2OKIVJp5iB_QtIpCO2yjNIiJc",
