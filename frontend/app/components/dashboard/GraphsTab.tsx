            ...
            <AreaChart data={chainHistory.data} stackOffset="expand">
              ...
              <RechartsTooltip
                formatter={(value: number, name: string) => [
                  `${value.toFixed(1)}%`,
                  chainHistory.series.find((s) => s.key === name)?.label ||
                    name,
                ]}
              />
        ...
        <Card className="p-6 bg-white shadow-sm">
          ...
          {loadingOv || !ov ? (
            ...
            <ResponsiveContainer width="100%" height={300}>
              ...
              >
                ...
                />
                <RechartsTooltip
                  formatter={(v: any, _n: any, e: any) => [fmtUSD(v), "24h Δ"]}
                />
                <Bar dataKey="pnl">
          ...
          {!loadingOv && !!ov && (
            <p className="text-xs text-slate-500 mt-2">
              Weighted move: {fmtUSD(pnlByChain.reduce((s, r) => s + r.pnl, 0))}{" "}
              over 24h.
            </p>
          )}
        </Card>
              ...
              return performanceData.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={300}>
                  ...
                  >
                    ...
                    <RechartsTooltip
                      formatter={(value: number, _name: string, props: any) => [
                        `${value >= 0 ? "+" : ""}${value.toFixed(2)}% (${fmtUSD(
                          props.payload.value
                        )})`,
                        "24h Change",
                      ]}
